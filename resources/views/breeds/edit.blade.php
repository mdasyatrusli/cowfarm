                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('breeds.update', $breed) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full focus:border-farm-green focus:ring-farm-green" type="text" name="name" :value="old('name', $breed->name)" required autofocus />
                            <x-input-error :messages="$errors->get('name')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="description" :value="__('Description (optional)')" />
                            <textarea id="description" name="description" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-farm-green focus:ring-farm-green" rows="3">{{ old('description', $breed->description) }}</textarea>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('breeds.index') }}" class="text-farm-brown hover:text-yellow-900">{{ __('Cancel') }}</a>
                        </div>
                    </form>
                </div>
            </div>
